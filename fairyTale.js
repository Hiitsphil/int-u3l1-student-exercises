...
document.querySelector("button").addEventListener("click", function() {
    ...
    document.querySelector("#smell").innerHTML= smell;
    document.querySelector("#feeling2").innerHTML= feeling2;
});
